...
<head>
    ...
    fbq('init', '726016971151524');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=726016971151524&ev=PageView&noscript=1"
    /></noscript>
    <!-- End Meta Pixel Code -->
    ...
    <script>
        function submitForm(event) {
            ...
            fetch("https://script.google.com/macros/s/AKfycbzklcr4FnTmbSjEdOICPc6dip6X3OAemT616D4xfTlf5ZPMxZW2_3iznGlNIuQKBXfg/exec", {  // Replace with your Google Apps Script URL
                method: "POST",
