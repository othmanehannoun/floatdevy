...
<head>
    ...
    <meta name="description" content="Discover FloaDevy's top-tier services in web development, mobile ecommerce, website creation, deployment, and custom web application solutions. Contact us for tailored strategies and superior digital experiences.">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100">
                        <div class="services-grid service-style-2">
                            <div class="thumbnail">
                                <img src="../assets/media/icon/icon-29.png" alt="Logo">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-6 col-md-12" data-sal="slide-up" data-sal-duration="800" data-sal-delay="200">
                        <div class="services-grid service-style-2">
                            <div class="thumbnail">
                                <img src="../assets/media/icon/icon-2.png" alt="Website Design">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-6 col-md-12" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                        <div class="services-grid service-style-2">
                            <div class="thumbnail">
                                <img src="../assets/media/icon/icon-28.png" alt="mobile app design">
                            </div>
                            <div class="content">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100">
                        <div class="services-grid service-style-2">
                            <div class="thumbnail">
                                <img src="../assets/media/icon/icon-31.png" alt="Development">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-6 col-md-12" data-sal="slide-up" data-sal-duration="800" data-sal-delay="200">
                        <div class="services-grid service-style-2">
                            <div class="thumbnail">
                                <img src="../assets/media/icon/icon-32.png" alt="Mobile app developmen">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-6 col-md-12" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                        <div class="services-grid service-style-2">
                            <div class="thumbnail">
                                <img src="../assets/media/icon/icon-33.png" alt="Website Developmen">
                            </div>
                            <div class="content">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12" data-sal="slide-up" data-sal-duration="800" data-sal-delay="100">
                        <div class="services-grid service-style-2">
                            <div class="thumbnail">
                                <img src="../assets/media/icon/icon-34.png" alt="Online Marketin">
                            </div>
                            <div class="content">
                    ...
                    <div class="col-lg-6 col-md-12" data-sal="slide-up" data-sal-duration="800" data-sal-delay="200">
                        <div class="services-grid service-style-2">
                            <div class="thumbnail">
                                <img src="../assets/media/icon/icon-35.png" alt="Social Media marketing">
                            </div>
                            <div class="content">
                    ...
                    <!-- <div class="col-lg-4 col-md-6" data-sal="slide-up" data-sal-duration="800" data-sal-delay="300">
                        <div class="services-grid service-style-2">
                            ...
                            <div class="content">
                                ...
                                <p>We design professional looking yet Mobile Apps. Our designs are search engine and user friendly. </p>
                                <a href="service-marketing.html" class="more-btn">Find out more</a>
                            </div>
                        </div>
                    </div>
